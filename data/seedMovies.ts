...
export const SEED_MOVIES: Movie[] = [
  {
    ...
    video: { key: 'YoHD9XEInc0', start: 5, end: 25, source: 'trailer', short: { key: '016oATNWjko', official: false, seconds: 58 } },
    themeColor: '#081426',
  ...
  },
  {
    ...
    providers: ['Max', 'Hulu'],
    video: { key: '5xH0Rqa1VDg', start: 4, end: 22, source: 'trailer', short: { key: 'ni8W9YKqu1g', official: false, seconds: 20 } },
    themeColor: '#092117',
  ...
  },
  {
    ...
    video: { key: 'EXeTwQWrcwY', start: 10, end: 30, source: 'trailer', short: { key: 'LNG4e7a-rRg', official: false, seconds: 31 } },
    themeColor: '#0f172a',
  ...
  },
  {
    ...
    video: { key: 'g4Hbz2jLxvQ', start: 5, end: 25, source: 'trailer', short: { key: 'Vo8dSsbIppg', official: false, seconds: 28 } },
    themeColor: '#240838',
  ...
  },
  {
    ...
    video: { key: 'zSWdZVtXT7E', start: 8, end: 28, source: 'trailer', short: { key: 'U95BjuCB_14', official: false, seconds: 14 } },
    themeColor: '#070b14',
